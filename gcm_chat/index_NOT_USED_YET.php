...
<html>
    <head>
        <title>OurAfrika 3.0 | AndroidHive</title>
        <meta charset="UTF-8">
    ...
    <body>
        <div class="header">
            <label class="logo">Tour Our Afrika</label>
            <h2>OurAfrika</h2>
            <h2 class="small">Virtually travel and Chat to fellow Africans. Learn a thing or two. #Unite</h2>
        </div>
        <div class="container_body">
            <div class="topics">
                <h2 class="heading">Download & Install the OurAfrika apk from Google Play</h2>
                Download & Install the OurAfrika <a href="#">apk</a>  <br/><br/>Once installed, refresh this page 
