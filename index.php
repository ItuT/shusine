...
<html lang="en">
    ...
    <head>
        ...
        <title>Shushine - Responsive Agency Template</title>
		...
		<nav class="navbar" role="navigation">
			<div class="container">
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="index.php">Shushine - with us your business shines...</a>
				</div>
        	...
        	<div class="container">
        		<div class="row">
	        		<div class="col-sm-12 wow fadeInLeftBig">
	            		<h1>We are <span class="violet">Shushine</span>, with us your business shines.</h1>
	            		<p>We build websites, mobile and desktop applications. Let us help you automate your work.</p>
	            	</div>
            	</div>
        	</div>
        </div>
	            ...
	            <div class="row">
	            	<div class="col-sm-3">
		                <div class="service wow fadeInUp">
		                    ...
		                    <h3>Shushine ~ Auto Mechanics</h3>
		                    <p>Get repairs on your car... get your car serviced... Get advice on car care...</p>
	                ...
	                <div class="col-sm-3">
		                <div class="service wow fadeInUp">
		                    ...
		                    <h3>Shushine ~ Business Management</h3>
		                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et...</p>
		                    <a class="big-link-1" href="services.html">Read more</a>
		                </div>
	                </div>
	                			...
	                			<div role="tabpanel" class="tab-pane fade in active" id="tab1">
	                				...
	                				<div class="testimonial-text">
		                                <p>
		                                	...
		                                	<a href="#">Lorem Ipsum, shushine.co.za</a>
		                                </p>
	                                </div>
	                			</div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-3 footer-box wow fadeInDown">
                        ...
                        <div class="footer-box-text footer-box-text-contact">
	                        <p><i class="fa fa-map-marker"></i> Address: Sandton, Gauteng, South Africa</p>
	                        <p><i class="fa fa-phone"></i> Phone: +27 736 369 058</p>
	                        <p><i class="fa fa-user"></i> Skype: Shushine_Agency</p>
	                        <p><i class="fa fa-envelope"></i> Email: <a href="">tlalii663@gmail.com</a></p>
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-sm-7 footer-copyright wow fadeIn">
                        <p>Copyright 2016 Shushine - All rights reserved.</p>
                    </div>
